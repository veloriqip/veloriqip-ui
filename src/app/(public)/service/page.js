...
export const metadata = {
  title: "Our Services",
  description:
    "Discover Veloriq IP's professional IP services including patent filings, trademarks, copyright protection, and IP consulting.",
